...
@click.option("--segmentation-backend", type=click.Choice(["sam2", "heuristic"]), default="heuristic", help="Segmentation backend")
...
@click.option("--segmentation-backend", type=click.Choice(["sam2", "heuristic"]), default="heuristic")
